...
public class UsuarioList extends javax.swing.JFrame {
    ...
    private UsuarioTableModel uModel;

    private void atualizaTabela() {
        ArrayList<Usuario> lista = RevendaCliente.conexaocontroller.usuarioLista();
        uModel = new UsuarioTableModel(lista);
        jTableCategorias.setModel(uModel);
    }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (jTableCategorias.getSelectedRow() >= 0) {
            ...
            Usuario usuario = uModel.getUsuario(
                    jTableCategorias.getSelectedRow());
            int result = JOptionPane.showConfirmDialog(this, "Deseja Excluir?", 
                    "usuario: " + 
                    usuario.getNome(), JOptionPane.YES_NO_OPTION);
            if (result == JOptionPane.YES_OPTION) {
                if (RevendaCliente.conexaocontroller.usuarioExcluir(usuario)) {
    ...
    private void jTableCategoriasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableCategoriasMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            if (jTableCategorias.getSelectedRow() >= 0) {
                UsuarioForm telaCadastrou = new UsuarioForm();
                telaCadastrou.setUsuario(uModel.getUsuario(jTableCategorias.getSelectedRow()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new UsuarioList().setVisible(true));
    }
